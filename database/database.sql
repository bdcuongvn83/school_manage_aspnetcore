...
/****** Object:  Database [university_db]    Script Date: 1/12/2025 7:42:24 AM ******/
CREATE DATABASE [university_db]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'university_db', FILENAME = N'Q:\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\university_db.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'university_db_log', FILENAME = N'Q:\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\university_db_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [university_db] SET  ENABLE_BROKER 
GO
...
ALTER DATABASE [university_db] SET READ_COMMITTED_SNAPSHOT ON 
GO
...
ALTER DATABASE [university_db] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO

ALTER DATABASE [university_db] SET DELAYED_DURABILITY = DISABLED 
GO

ALTER DATABASE [university_db] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO

ALTER DATABASE [university_db] SET QUERY_STORE = ON
GO

ALTER DATABASE [university_db] SET QUERY_STORE (OPERATION_MODE = READ_WRITE, CLEANUP_POLICY = (STALE_QUERY_THRESHOLD_DAYS = 30), DATA_FLUSH_INTERVAL_SECONDS = 900, INTERVAL_LENGTH_MINUTES = 60, MAX_STORAGE_SIZE_MB = 1000, QUERY_CAPTURE_MODE = AUTO, SIZE_BASED_CLEANUP_MODE = AUTO, MAX_PLANS_PER_QUERY = 200, WAIT_STATS_CAPTURE_MODE = ON)
GO
